...
//resource "aws_ami_copy" "ubuntu_1604_encrypted" {
//  name              = "${data.aws_ami.ubuntu_1604.name}-encrypted"
//  description       = "${data.aws_ami.ubuntu_1604.description} (encrypted)"
//  source_ami_id     = data.aws_ami.ubuntu_1604.id
